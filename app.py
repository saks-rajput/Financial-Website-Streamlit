...
Note: this file's imports from ratio_engine.py (calculate_bank_ratios,
format_bank_ratio, is_financial_institution) only exist starting with
the version of ratio_engine.py that ships alongside this app.py. If you
update this file on its own without also updating ratio_engine.py,
extract_financials.py, generate_insights.py, and pdf_text_extractor.py
at the same time, you'll get an ImportError - these five files are meant
to be deployed together as a matching set.
