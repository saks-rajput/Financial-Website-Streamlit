...
The five section headers below ("## Executive Summary", "## Strengths",
etc.) aren't just cosmetic - app.py's _parse_narrative_sections() splits
on them to route each part into its own tab (Executive Summary, Risks,
YoY Trend), so if you ever change the wording of a header here, update
that parser too.
